...
### GetContactCountByCenter
#### Required Arguments
```dart
// No required arguments
DefaultConnector.instance.getContactCountByCenter().execute();
```



#### Return Type
`execute()` returns a `QueryResult<GetContactCountByCenterData, void>`
```dart
/// Result of an Operation Request (query/mutation).
class OperationResult<Data, Variables> {
  OperationResult(this.dataConnect, this.data, this.ref);
...
final result = await DefaultConnector.instance.getContactCountByCenter();
GetContactCountByCenterData data = result.data;
final ref = result.ref;
```
...
An example of how to use the `Ref` object is shown below:
```dart
final ref = DefaultConnector.instance.getContactCountByCenter().ref();
ref.execute();
...
String uid = ...;
String name = ...;
DefaultConnector.instance.updateUserProfile(
  uid: uid,
  name: name,
).execute();
```
...
class UpdateUserProfileVariablesBuilder {
  ...
   UpdateUserProfileVariablesBuilder email(String? t) {
   _email.value = t;
   return this;
  }
...
final result = await DefaultConnector.instance.updateUserProfile(
  uid: uid,
  name: name,
);
...
final ref = DefaultConnector.instance.updateUserProfile(
  uid: uid,
  name: name,
).ref();
ref.execute();
...
int sortOrder = ...;
String assignedByUid = ...;
DefaultConnector.instance.reassignContact(
  contactId: contactId,
  enablerUid: enablerUid,
  eventId: eventId,
  sortOrder: sortOrder,
...
#### Return Type
`execute()` returns a `OperationResult<ReassignContactData, ReassignContactVariables>`
```dart
/// Result of an Operation Request (query/mutation).
class OperationResult<Data, Variables> {
  OperationResult(this.dataConnect, this.data, this.ref);
...
final result = await DefaultConnector.instance.reassignContact(
  contactId: contactId,
  enablerUid: enablerUid,
  eventId: eventId,
  sortOrder: sortOrder,
...
ReassignContactData data = result.data;
final ref = result.ref;
```
...
final ref = DefaultConnector.instance.reassignContact(
  contactId: contactId,
  enablerUid: enablerUid,
  eventId: eventId,
  sortOrder: sortOrder,
...
UserRole role = ...;
bool isActive = ...;
DefaultConnector.instance.migrateUserIdentity(
  oldUid: oldUid,
  newUid: newUid,
  phone: phone,
...
#### Return Type
`execute()` returns a `OperationResult<MigrateUserIdentityData, MigrateUserIdentityVariables>`
```dart
/// Result of an Operation Request (query/mutation).
class OperationResult<Data, Variables> {
  OperationResult(this.dataConnect, this.data, this.ref);
...
final result = await DefaultConnector.instance.migrateUserIdentity(
  oldUid: oldUid,
  newUid: newUid,
  phone: phone,
  dummyPhone: dummyPhone,
...
MigrateUserIdentityData data = result.data;
final ref = result.ref;
```
...
final ref = DefaultConnector.instance.migrateUserIdentity(
  oldUid: oldUid,
  newUid: newUid,
  phone: phone,
  dummyPhone: dummyPhone,
...
```dart
String uid = ...;
DefaultConnector.instance.adminDeleteUser(
  uid: uid,
).execute();
```
...
#### Return Type
`execute()` returns a `OperationResult<AdminDeleteUserData, AdminDeleteUserVariables>`
```dart
/// Result of an Operation Request (query/mutation).
class OperationResult<Data, Variables> {
  OperationResult(this.dataConnect, this.data, this.ref);
...
final result = await DefaultConnector.instance.adminDeleteUser(
  uid: uid,
);
AdminDeleteUserData data = result.data;
final ref = result.ref;
```
...
final ref = DefaultConnector.instance.adminDeleteUser(
  uid: uid,
).ref();
ref.execute();
```
