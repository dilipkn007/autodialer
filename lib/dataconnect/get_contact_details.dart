...
class GetContactDetailsVariablesBuilder {
  String id;

  final FirebaseDataConnect _dataConnect;
  GetContactDetailsVariablesBuilder(this._dataConnect, {required  this.id,});
  Deserializer<GetContactDetailsData> dataDeserializer = (dynamic json)  => GetContactDetailsData.fromJson(jsonDecode(json));
  Serializer<GetContactDetailsVariables> varsSerializer = (GetContactDetailsVariables vars) => jsonEncode(vars.toJson());
  Future<QueryResult<GetContactDetailsData, GetContactDetailsVariables>> execute() {
    return ref().execute();
  }

  QueryRef<GetContactDetailsData, GetContactDetailsVariables> ref() {
    GetContactDetailsVariables vars= GetContactDetailsVariables(id: id,);
    return _dataConnect.query("GetContactDetails", dataDeserializer, varsSerializer, vars);
  }
}

@immutable
class GetContactDetailsContact {
  final String id;
  final String name;
  final String mobile;
  final String? email;
  ...
  GetContactDetailsContact.fromJson(dynamic json):
  ...
  bool operator ==(Object other) {
    ...
    final GetContactDetailsContact otherTyped = other as GetContactDetailsContact;
...
@immutable
class GetContactDetailsData {
  final GetContactDetailsContact? contact;
  GetContactDetailsData.fromJson(dynamic json):
  
  contact = json['contact'] == null ? null : GetContactDetailsContact.fromJson(json['contact']);
  @override
  bool operator ==(Object other) {
    if(identical(this, other)) {
      return true;
    ...
    final GetContactDetailsData otherTyped = other as GetContactDetailsData;
...
@immutable
class GetContactDetailsVariables {
  final String id;
  @Deprecated('fromJson is deprecated for Variable classes as they are no longer required for deserialization.')
  GetContactDetailsVariables.fromJson(Map<String, dynamic> json):
  ...
  bool operator ==(Object other) {
    ...
    final GetContactDetailsVariables otherTyped = other as GetContactDetailsVariables;
    return id == otherTyped.id;
